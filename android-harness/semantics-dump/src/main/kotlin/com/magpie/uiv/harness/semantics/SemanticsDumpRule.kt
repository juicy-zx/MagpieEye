...
/**
 * semantics-exporter(设计文档 2.3 节,按 C5 修正口径)。
 ...
 * Compose 依赖在制品侧为 compileOnly —— 目标工程供自己的 Compose 测试运行时。
 */
class SemanticsDumpRule(private val outDir: File = File("build/uiv")) {
