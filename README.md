...
UI 视觉自校验系统:对 Figma 设计稿与 Android 实现(Jetpack Compose 与 XML View
双轨)做自动视觉一致性验证。
...
| `demo-android` | 示例 Android 工程(Compose 与 XML View 双轨 fixture,Roborazzi/Robolectric 渲染;XML 侧语义导出见 `ViewDumpRule`) |
