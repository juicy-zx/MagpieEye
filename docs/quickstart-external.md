...
```bash
git clone https://github.com/juicy-zx/MagpieEye.git   # 源码即交付物(LICENSE=UNLICENSED,保留所有权利)
cd magpie_eye
...
dependencies {
    ...
    testImplementation("com.magpie.uiv:view-dump:0.1.0")
    // testImplementation("com.magpie.uiv:semantics-dump:0.1.0")
